...
- [x] 1. Add reproduction cooldown and readiness config fields to ActorConfig
  ...
  - [x] 1.2 Add config validation to `validate_world_config` in `src/io/config_file.rs`
...
- [x] 2. Add reproduction_cooldown to HeritableTraits and cooldown_remaining to Actor
  - [x] 2.1 Add `reproduction_cooldown: u16` field to `HeritableTraits` in `src/grid/actor.rs`
  ...
  - [x] 2.2 Add `cooldown_remaining: u16` field to `Actor` in `src/grid/actor.rs`
...
- [x] 3. Add reproductive readiness cost to run_actor_metabolism
  - [x] 3.1 Update `run_actor_metabolism` in `src/grid/actor_systems.rs`
...
- [x] 4. Add cooldown gate to run_actor_reproduction
  - [x] 4.1 Update `run_actor_reproduction` in `src/grid/actor_systems.rs`
...
- [x] 6. Update genetic distance
  - [x] 6.1 Update `genetic_distance` in `src/grid/actor_systems.rs`
...
- [x] 7. Update visualization layer
  - [x] 7.1 Update `TraitStats` and `compute_trait_stats_from_actors` in `src/viz_bevy/resources.rs` and `src/viz_bevy/systems.rs`
  ...
  - [x] 7.2 Update `TRAIT_NAMES`, `format_actor_info`, and `format_config_info` in `src/viz_bevy/setup.rs`
...
- [x] 8. Update configuration documentation
  - [x] 8.1 Update `example_config.toml`
  ...
  - [x] 8.2 Update `config-documentation.md` steering file

...
- [ ] 1. Add Bevy dependency and create module skeleton
...
- [ ] 2. Implement pure normalization function
  - [ ] 2.1 Implement `normalize_field` in `src/viz_bevy/normalize.rs`
...
- [ ] 3. Implement color mapping functions
  - [ ] 3.1 Implement `heat_color_rgba` and `chemical_color_rgba` in `src/viz_bevy/color.rs`
